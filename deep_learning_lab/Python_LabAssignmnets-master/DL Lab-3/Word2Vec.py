...
# # Step 1: The data.
data_dir = "data"
data_url = 'https://www.gutenberg.org/files/1063/1063.zip'
...
def fetch_words_data(url=data_url, words_data=data_dir):
    ...
    # Path to zip file 
    zip_path = os.path.join(words_data, "pg1063.zip")
...
# Due 7/13/2018
#
# The hyperparameters I changed:
#   Embedding size (150 -> 10)
#   Model learning rate (0.01 -> 0.50)
#   Valid size (16 -> 5)
